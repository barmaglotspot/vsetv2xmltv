...
class parser:
    __slots__ = ('Channels', 'Programmes', 'CountDay', 'FullDesc', 'XMLOut')

    def __init__(self, vXMLOut, vCountDay=3, vFullDesc='false', vCfgFile='channels.cfg'):
        try:                        
            self.Programmes = programme.programme_list()
            self.CountDay = vCountDay
            self.FullDesc = vFullDesc
            self.XMLOut = vXMLOut
            self.Channels = channel.channel_list(vCfgFile)
            self.Channels.load_channels_from_file()
        except Exception, e:
            common.dbg_log('parser::__init__', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def remove_tags(self, vstr):
        try: 
            ...
            common.dbg_log('parser::remove_tags', 'ERROR: (' + repr(e) + ')', 1)
            return vstr
    ...
    def parse_strings(self, vstr, vbegin, vend, vrtags=0): 
        try:
            ...
            common.dbg_log('parser::parse_strings', 'ERROR: (' + repr(e) + ')', 1)
            return vstr        
    ...
    def addzero(self, vstr):
        try:
            ...
            common.dbg_log('parser::addzero', 'ERROR: (' + repr(e) + ')', 1)
            return '00'
    ...
    def get_datetime_fmt(self, vdate, vtimestr, vcorrection):
        try:
            ...
            common.dbg_log('parser::get_datetime_fmt', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def get_content(self):
        try:
            ...
            common.dbg_log('parser::get_content', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def get_content_day(self,  vchanneldata, vdate):
        try:
            ...
            common.dbg_log('parser::get_content_day', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def get_desc(self, vprogrammedata, vcontent):
        try:
            ...
            common.dbg_log('parser::get_desc', 'ERROR: (' + repr(e) + ')', 1)        
    ...
    def get_fulldesc(self, vprogrammedata, vcontent):
        try:
            ...
            common.dbg_log('parser::get_fulldesc', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def get_category_from_title(self, vprogrammedata):
        try:
            ...
            common.dbg_log('parser::get_category_from_title', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def save_xml(self):
        try:
            ...
            common.dbg_log('parser::save_xml', 'ERROR: (' + repr(e) + ')', 1)