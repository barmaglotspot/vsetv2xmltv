...
class programme:
    ...
    def __init__(self, vChannelIdx, vStart, vTitle, vStop='', vDesc='', vFullDesc='', vCategoryLang1='', vCategoryLang2='', vDirectors='', vActors='', vDate='', vStarrating=''):
        try:
            ...
            common.dbg_log('programme::__init__', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def copy_fulldesc(self, vprg):
        try:
            ...
            common.dbg_log('programme_list::copy_fulldesc', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def get_xml(self, vxmldoc, vnode):
        try:
            ...
            common.dbg_log('programme::get_xml', 'ERROR: (' + repr(e) + ')', 1)
...
class programme_list:
    ...
    def __init__(self):
        try:
            ...
            common.dbg_log('programme_list::__init__', 'ERROR: (' + repr(e) + ')', 1) 
    ...
    def set_programme_stop(self):
        try:
            ...
            common.dbg_log('programme_list::set_programme_stop', 'ERROR: (' + repr(e) + ')', 1)       
    ...
    def get_xml(self, vxmldoc, vnode):
        try:
            ...
            common.dbg_log('programme_list::get_xml', 'ERROR: (' + repr(e) + ')', 1)
    ...
    def get_programme_for_url(self, vurl):
        try:
            ...
            common.dbg_log('programme_list::get_programme_for_url', 'ERROR: (' + repr(e) + ')', 1)
            return None